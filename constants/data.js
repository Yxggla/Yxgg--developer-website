const userData = {
  ...
  about: {
    ...
    MajorCourse2: [
      [
        "",
        "传播学理论基础,数据科学编程基础,动态网络与手机程式编写,推荐系统与数码媒体,大数据管理与分析,数码媒体中的人工智能,人工智能与数码媒体工作坊,数据挖掘与知识发现,算法文化,数码媒体研究",
      ],

    ],
    title:
      "人工智能与数码方向研究生，从影像创作转向前端开发再走向 AI 工程",
    description: [
      ...
      "在学习深入的过程中，我将重心转向<strong>前端与应用开发</strong>，并开始系统性地结合<strong>人工智能技术</strong>进行实践。我熟悉 JavaScript、TypeScript 等工程语言，熟练使用 React框架，并将其作为 AI 能力的承载与放大器。",
  ...
  resumeUrl1: "https://github.com/user-attachments/files/25030549/2026.pdf", //前端
